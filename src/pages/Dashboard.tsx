...
export default function Dashboard() {
	...
	const quickActions: Array<{
	...
	}> = [
		{
			...
			description:
				"Xem danh mục các trường, quản lý lớp học và danh sách học sinh.",
			icon: "apartment",
			path: "/schools",
			shape: "arch",
			...
			? [
					{
						...
						description:
							"Cấu hình tiêu chuẩn chấm thi tự động bài làm MOS Word, Excel, PowerPoint.",
						icon: "rule",
					...
					},
					{
						...
						description:
							"Quản lý tài khoản giáo viên, trạng thái phê duyệt và vai trò hệ thống.",
						...
						>
							<div className="grid place-items-center text-center p-3 text-m3-on-secondary">
								<Icon
									...
									variant="rounded"
								/>
								<span className="mt-1 text-xs font-bold tracking-wider uppercase opacity-90">
									MOS Grade
								</span>
							</div>
						</ShapeMedia>
			...
			<section className="rounded-m3-lg bg-m3-surface-container p-6 sm:p-8">
				...
				<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
					{workflowSteps.map((ws) => (
						...
						>
							<div className="flex items-center justify-between">
								<span className="text-2xl font-black text-m3-primary/50">
									{ws.step}
								</span>
