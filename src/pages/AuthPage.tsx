...
import { Button, Divider, Icon, ProgressIndicator, ShapeMedia, TextField, useThemeMode } from '@bug-on/m3-expressive';
            ...
            {isLogin && hasGoogleClientId && (
              <>
                ...
                <div className="relative flex w-full justify-center">
                  ...
                  <div className={`flex w-full justify-center transition-opacity ${isAuthBusy ? 'pointer-events-none opacity-60' : ''}`}>
                    <GoogleLogin
                      onSuccess={handleGoogleLoginSuccess}
                      onError={() => setError('Đăng nhập Google thất bại')}
                      useOneTap={false}
                      theme={effectiveMode === 'dark' ? 'filled_black' : 'outline'}
                      size="large"
                      shape="pill"
                      text="continue_with"
                    />
