    ...
    <div className="max-w-4xl mx-auto p-4">
      ...
      {!result ? (
        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700 mb-1">Chọn dự án đề bài</label>
            <select
              value={projectCode}
          ...
          <div className="mb-6">
            ...
            >
              ...
              <label htmlFor="student-upload" className="cursor-pointer text-center">
                ...
                <p className="text-xs text-gray-500 mt-1">Kéo thả file vào đây hoặc bấm để chọn</p>
                {studentFile && (
