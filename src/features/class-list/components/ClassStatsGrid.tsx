...
const StatCard: React.FC<StatItemProps> = ({
	...
	<Card
		variant="filled"
		className="rounded-3xl border-none bg-m3-surface-container p-5 text-m3-on-surface shadow-xs"
	>
		<CardContent className="p-0">
			<div className="flex items-center justify-between">
				<div>
					...
					<p
						className={`mt-1 text-2xl font-bold tracking-tight ${textColorClass || ""}`}
					>
						{value}
					</p>
				</div>
