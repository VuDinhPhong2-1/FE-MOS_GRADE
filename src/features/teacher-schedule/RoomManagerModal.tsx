	...
	return (
		<Dialog open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
			<DialogPortal open={open}>
				...
				>
					{/* Header */}
					<div className="border-b border-m3-outline-variant/60 bg-m3-surface-container-high px-4 py-4 sm:px-6 shadow-xs">
						<div className="flex flex-wrap items-start justify-between gap-3">
							<DialogHeader className="mb-0 flex-row items-start gap-3 space-y-0 text-left">
								...
								<div className="space-y-2">
									<div>
										<DialogTitle className="text-xl font-bold text-m3-on-surface font-md3-expressive">
											Quản lý phòng máy
										</DialogTitle>
										<DialogDescription className="mt-1 text-sm text-m3-on-surface-variant">
						...
						<div className="grid gap-5 xl:grid-cols-[minmax(0,1.25fr)_400px]">
											...
											<label className="grid gap-1.5 text-sm">
												...
												<div className="relative">
													<select
														...
														className="min-w-65 w-full appearance-none rounded-xl border border-m3-outline-variant bg-m3-surface-container-high px-3.5 py-2.5 pr-9 text-m3-on-surface focus:border-m3-primary focus:outline-hidden"
													>
							...
							>
								...
								<div className="min-h-0 flex-1 space-y-4 overflow-y-auto p-4">
									<div className="rounded-2xl border border-m3-outline-variant/60 bg-m3-surface-container-high p-4 shadow-xs">
										<label className="grid gap-1.5 text-sm">
											<span className="font-semibold text-m3-on-surface">
												Tên phòng máy
											</span>
											<input
												...
												className="w-full rounded-xl border border-m3-outline-variant/60 bg-m3-surface-container px-3 py-2.5 text-sm text-m3-on-surface outline-none focus:border-m3-primary"
												required
											/>
										</label>
									</div>

									<div className="rounded-3xl border border-m3-outline-variant/60 bg-m3-surface-container-high p-4 shadow-xs">
										...
										<div className="grid gap-3 grid-cols-[repeat(auto-fit,minmax(108px,1fr))]">
											<label className="grid min-w-0 gap-1.5 text-sm">
												...
												<input
													...
													className="w-full rounded-xl border border-m3-outline-variant/60 bg-m3-surface-container px-3 py-2 text-sm text-m3-on-surface outline-none focus:border-m3-primary"
													required
												/>
											</label>
											<label className="grid min-w-0 gap-1.5 text-sm">
										...
										<label className="mt-3 grid gap-1.5 text-sm">
											...
											<textarea
												...
												className="min-h-18 w-full rounded-xl border border-m3-outline-variant/60 bg-m3-surface-container p-3 text-sm text-m3-on-surface outline-none focus:border-m3-primary"
											/>
											<span className="text-xs text-m3-on-surface-variant">
												Mô tả cụ thể từng máy hỏng — không ảnh hưởng tới số
												lượng máy lỗi ở trên.
											</span>
										</label>
									</div>
								...
								<div className="shrink-0 border-t border-m3-outline-variant/60 bg-m3-surface-container px-4 py-4 sm:px-6">
