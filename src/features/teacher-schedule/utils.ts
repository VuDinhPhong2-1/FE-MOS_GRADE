...
export const createDefaultRoomForm = (schoolId = ''): ComputerRoomFormState => ({
  schoolId,
  name: '',
...
export const calculateMissingMachinesByFormula = (data: ScheduleAttendanceResponse): number | null => {
...
export const buildAttendanceDraft = (data: ScheduleAttendanceResponse): Record<string, AttendanceDraftState> => {
...
export const buildReportsDraft = (data: ScheduleAttendanceResponse, teacherName: string): ScheduleReportsPayload => {
