...
const modelPublicationRows = [
	[
		"ExamPublication",
		"Cấu hình phát hành ca thi",
		"Lưu cấu hình của ca thi được giáo viên phát hành.",
	],
	[
		"projectSequence",
		"Danh sách project theo thứ tự",
		"Quy định học sinh phải làm Project 01, rồi Project 02, rồi Project 03...",
	],
	["order", "Thứ tự project", "Số thứ tự của project trong ca thi."],
	[
		"projectCode",
		"Mã project",
		"Mã định danh project, ví dụ WORD_P01 hoặc EXCEL_P02.",
	],
	[
		"subject",
		"Môn/ứng dụng thi",
		"Cho biết project thuộc Word, Excel, PowerPoint...",
	],
	[
		"templateFileName",
		"Tên file mẫu",
		"Tên file gốc mà Agent sẽ copy để học sinh làm bài.",
	],
	[
		"gradingApiEndpoint",
		"Đường dẫn API chấm điểm",
		"Endpoint dùng để gửi file bài làm lên hệ thống chấm.",
	],
	[
		"taskSnapshot",
		"Bản sao danh sách task",
		"Lưu danh sách yêu cầu của project tại thời điểm phát hành để tránh bị thay đổi về sau.",
	],
	[
		"modeRules",
		"Quy tắc theo chế độ",
		"Quy định khác nhau giữa Training và Testing, ví dụ hiển thị feedback hay không.",
	],
];
...
const modelSessionRows = [
	[
		"ExamSession",
		"Phiên làm bài/phiên thi",
		"Đại diện cho toàn bộ ca thi của một học sinh.",
	],
	[
		"currentProjectIndex",
		"Vị trí project hiện tại",
		"Cho biết học sinh đang ở project số mấy trong projectSequence.",
	],
	[
		"currentProjectStatus",
		"Trạng thái project hiện tại",
		"Cho biết project hiện tại đang làm, đã nộp, đã chấm hay lỗi.",
	],
	[
		"projectAttempts[]",
		"Danh sách lần làm từng project",
		"Lưu kết quả và file làm bài của từng project con.",
	],
	[
		"completedProjectCount",
		"Số project đã hoàn thành",
		"Dùng để hiển thị tiến độ như Project 2/10.",
	],
	[
		"aggregateScore",
		"Điểm tổng toàn ca thi",
		"Điểm tổng hợp sau khi hoàn tất tất cả project.",
	],
];

const modelAttemptRows = [
	[
		"ExamSessionProjectAttempt",
		"Lần làm bài của project",
		"Bản ghi chi tiết cho một project trong ca thi.",
	],
	["projectCode", "Mã project", "Liên kết attempt với project cụ thể."],
	[
		"subject",
		"Môn/ứng dụng thi",
		"Xác định Word/Excel/PowerPoint để mở đúng phần mềm.",
	],
	[
		"templateFileName",
		"Tên file mẫu",
		"File gốc để copy khi bắt đầu hoặc restart project.",
	],
	[
		"workingFilePath",
		"Đường dẫn file đang làm",
		"File thực tế mà học sinh đang chỉnh sửa trong thư mục Exam.",
	],
	...
	[
		"submittedAt",
		"Thời điểm nộp",
		"Ghi nhận khi project được submit (nộp bài).",
	],
	["score", "Điểm project", "Điểm riêng của project hiện tại."],
	[
		"feedback",
		"Phản hồi/chấm lỗi",
		"Chi tiết lỗi hoặc nhận xét theo từng task.",
	],
	[
		"attemptNo",
		"Số lần làm lại",
		"Tăng khi học sinh restart hoặc làm lại project hiện tại.",
	],
];
...
const apiRows = [
	[
		...
		"Giáo viên tạo publication/ca thi gồm nhiều project theo thứ tự.",
	],
	[
		"Student Public API",
		"GET /api/public/exams/{token}/sessions/{sessionId}",
		"FE học sinh lấy trạng thái session và project hiện tại.",
	],
	[
		"Student Public API",
		"POST /api/public/exams/{token}/sessions/{sessionId}/next-project",
		"FE yêu cầu chuyển sang project kế tiếp.",
	],
	[
		"Local Agent API",
		"POST /start-exam",
		"Agent bắt đầu ca thi và mở project đầu tiên.",
	],
	[
		"Local Agent API",
		"POST /submit-current-project",
		"Agent nộp file của project hiện tại để chấm.",
	],
	[
		"Local Agent API",
		"POST /next-project",
		"Agent submit project hiện tại, chờ chấm, rồi mở project kế tiếp.",
	],
	[
		"Local Agent API",
		"POST /restart-current-project",
		"Agent reset/làm lại đúng project đang làm.",
	],
	[
		"Local Agent API",
		"GET /current-state",
		"FE lấy trạng thái hiện tại từ Agent local.",
	],
	[
		"Agent-facing Backend API",
		"POST /api/agent/exam-sessions/{sessionId}/projects/{projectCode}/score-upload",
		"Agent/backend chấm điểm gửi kết quả project lên backend.",
	],
	[
		"Agent-facing Backend API",
		"POST /api/agent/exam-sessions/{sessionId}/advance",
		"Backend xác nhận và chuyển session sang project tiếp theo.",
	],
	[
		"Agent-facing Backend API",
		"GET /api/agent/exam-sessions/{sessionId}/current-project-bootstrap",
		"Agent lấy dữ liệu khởi tạo project hiện tại hoặc kế tiếp.",
	],
];
...
const feAgentRows = [
	[
		"FE học sinh",
		"Nút Project tiếp theo",
		"Cho phép học sinh chuyển sang project kế tiếp sau khi làm xong project hiện tại.",
	],
	[
		"FE học sinh",
		"Progress Project 1/10",
		"Hiển thị học sinh đang ở project số mấy trên tổng số project.",
	],
	[
		"FE học sinh",
		"Task list động",
		"Task list và instruction panel phải đổi theo project hiện tại.",
	],
	[
		"FE học sinh",
		"Khóa thao tác khi chuyển bài",
		"Tránh học sinh bấm nhiều lần trong lúc Agent đang submit/chấm/mở bài mới.",
	],
	[
		"FE giáo viên",
		"Chọn danh sách project theo thứ tự",
		"Màn tạo publication cho phép kéo/thả hoặc chọn thứ tự project.",
	],
	[
		"FE giáo viên",
		"Monitor project hiện tại",
		"Màn monitor cần hiển thị học sinh đang ở project số mấy, không chỉ started/submitted.",
	],
	[
		"Local Agent",
		"current project context",
		"Agent lưu ngữ cảnh project hiện tại: projectCode, file path, status, sessionId.",
	],
	[
		"Local Agent",
		"Chống bấm đúp next-project",
		"Không cho mở hai project kế tiếp cùng lúc.",
	],
	[
		"Local Agent",
		"Từ chối advance khi submit lỗi",
		"Nếu upload/chấm thất bại thì giữ nguyên project hiện tại.",
	],
	[
		"Local Agent",
		"Luôn lấy file từ Template",
		"Không tái sử dụng file đã làm từ project trước.",
	],
];
...
const glossaryRows = [
	[
		"Publication",
		"Đợt phát hành đề/ca thi",
		"Cấu hình do giáo viên tạo để học sinh vào làm bài.",
	],
	[
		"Session",
		"Phiên làm bài",
		"Một lượt làm bài của một học sinh trong một ca thi.",
	],
	[
		"Project",
		"Bài thi con",
		"Một phần bài thi Word/Excel/PowerPoint trong ca thi.",
	],
	["Attempt", "Lần làm bài", "Một lần thực hiện hoặc nộp một project."],
	[
		"Local Agent",
		"Ứng dụng chạy trên máy học sinh",
		"Phần mềm local có nhiệm vụ mở file, copy template, submit file và chuyển bài.",
	],
	[
		"Endpoint",
		"Đường dẫn API/chức năng API",
		"URL để FE, Agent hoặc service gọi backend thực hiện một chức năng.",
	],
	...
	[
		"Score Upload",
		"Gửi kết quả chấm",
		"Đẩy điểm và feedback của project về backend.",
	],
	[
		"Advance",
		"Chuyển bước/chuyển project",
		"Cập nhật session sang project tiếp theo.",
	],
	[
		"Bootstrap",
		"Dữ liệu khởi tạo",
		"Thông tin ban đầu để Agent mở đúng project/file/task.",
	],
	[
		"Task Snapshot",
		"Bản sao task tại lúc phát hành",
		"Giữ task ổn định dù project gốc bị chỉnh sửa sau này.",
	],
	["Mode Rules", "Quy tắc chế độ", "Các quy tắc riêng cho Training/Testing."],
	[
		"Current Project Context",
		"Ngữ cảnh project hiện tại",
		"Thông tin Agent đang giữ để biết file nào/project nào đang làm.",
	],
	[
		"Aggregate Score",
		"Điểm tổng",
		"Điểm tổng hợp của toàn bộ project trong session.",
	],
	[
		"Template",
		"File mẫu",
		"File gốc chưa làm bài, dùng để copy ra file làm bài.",
	],
	[
		"Working File",
		"File đang làm",
		"File học sinh đang chỉnh sửa trong thư mục Exam.",
	],
];
